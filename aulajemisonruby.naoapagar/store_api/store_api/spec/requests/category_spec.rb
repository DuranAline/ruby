  ...
  describe 'GET /index' do
    context 'quando há categorias cadastradas' do
      ...
      it 'retorna uma lista de categorias' do
        ...
        category2 = Category.create(description: 'Categoria 01')
  ...
  describe 'GET /show' do
    ...
    context 'quando a categoria existe' do
      ...
      it 'retorna uma categoria especifica' do
        ...
        category = Category.create(description:'Alimento')
...
describe 'POST /create'do
  context 'Com parametros validos' do
    ...
    context 'com parametros inválidos' do
      it 'Retorna erro erro de unprocessable entity' do
        post '/categories', params: {category: {descripition:nil}}
